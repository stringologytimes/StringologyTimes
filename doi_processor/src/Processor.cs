...
namespace DataProcessor
{
    class Processor
    {
        ...
        public static async Task<int> BuildCacheForPrimaryDOIElements(DBLPOptions opts)
        {
            ...
            await DOIElementPreprocessor.BuildCache(opts.DataFolderPath, opts.MailAddress, primaryDOISet);
        ...
        public static async Task<int> BuildCacheForSecondaryDOIElements(DBLPOptions opts)
        {
            var UrlPath = GetFilePathInAutoGeneratedFolder(opts.DataFolderPath, "url.csv");
            var TagPath = GetFilePathInAutoGeneratedFolder(opts.DataFolderPath, "tag.csv");
            ...
            await DOIElementPreprocessor.BuildCache(opts.DataFolderPath, opts.MailAddress, secondaryDOISet);
